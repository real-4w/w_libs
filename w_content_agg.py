...
class RedditSource(Source):
  """Create a class for connecting to Redit.

  Args: <none>
  """
  def connect(self, client_id: str, client_secret: str):
    """Connect to Reddit using praw module.
...
class RedditNew(RedditSource):
  """Create a class for getting content from Reddit r/<name>.

  Args:
      w_reddit (str): Reddit's r/<name>
